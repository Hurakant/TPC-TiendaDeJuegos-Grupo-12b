    ...
    <div class="row justify-content-center login-container">
        <div class="col-md-5">
            ...
            <div class="login-card">
                ...
                <asp:Panel ID="pnlPedirEmail" runat="server">
                    ...
                    <div class="d-grid gap-3">
                        <asp:Button Text="Enviar código" CssClass="btnIngresar" ID="btnEnviarCodigo" OnClick="btnEnviarCodigo_Click" runat="server" />
                        <asp:Label runat="server" ID="lblMsjPaso1" Visible="false" CssClass="d-block" />
                        <a href="Login.aspx" class="cancelar-link">Volver a iniciar sesión</a>
                    </div>

                </asp:Panel>

                <%-- PASO 2: ingresar codigo + nueva contraseña --%>
                <asp:Panel ID="pnlResetear" runat="server" Visible="false">
                    ...
                    <div class="d-grid gap-3">
                        ...
                        <asp:Label runat="server" ID="lblMsjPaso2" Visible="false" CssClass="d-block" />
                        <a href="Login.aspx" class="cancelar-link">Volver a iniciar sesión</a>
                    </div>
